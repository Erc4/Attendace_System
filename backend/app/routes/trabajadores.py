...
def create_trabajador(
    ...
    print(f"Datos recibidos: {trabajador.dict()}")  # Debug
    ...
    try:
        ...
        if trabajador_data.get('huellaDigital'):
            try:
                ...
                print(f"Error procesando huella: {e}")  # Debug
                raise HTTPException(
                    status_code=status.HTTP_400_BAD_REQUEST,
        ...
        print(f"Datos procesados: {trabajador_data}")  # Debug
        ...
        print(f"Trabajador creado con ID: {db_trabajador.id}")  # Debug
        
        return db_trabajador
        
    except Exception as e:
        print(f"Error al crear trabajador: {e}")  # Debug
        db.rollback()
        raise HTTPException(
...
def get_trabajadores(
    ...
    try:
        ...
        print(f"Error al obtener trabajadores: {e}")  # Debug
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
def get_trabajadores_lista(
    ...
    try:
        ...
        print(f"Error en get_trabajadores_lista: {e}")  # Debug
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error al obtener lista de trabajadores: {str(e)}"
        )